...
things that can not be done at human-scales.


There are still critical functions that the present
system provides that the system I am outlining can provide.
We still need means of coordinating propagation of
