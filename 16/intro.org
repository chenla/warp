...
not something that is built in garage by a couple of people
living on instant Raman and then launched as a complete
solution.  Rather it will evolve over time, first as a
overlap over existing political and economic systems.  As
more and more pieces of the system come on line they can
displace and retire existing systems.  This will take a long
time, generations, in fact.  There will be small pockets
emerging that will use use the system to run their own
company, or a village co-op or perhaps a housing
development.  At first ad hoc processes will be simply one
more revenue stream for a company, or a way of managing a
government agency or department.  Students will join the
network as part of a life-long learning program and use the
personal information framework to form ad hoc social media
groups, organize events and eventually after graduation to
use their own personal knowledge workshop as Engelbart
called it, as both their resume and portfolio but also as an
extension and externalization of their own knowledge and
