...
builds Pattern Language for generating a Hoard which will be
a sort of Application (tho that term is to be used extremely
loosely that will start from the assumption that the user
has nothing, not even the means for basic survival.
