...
#+begin_quote
Always try, at each moment, in every policy, in every
action, in every line and every shape, to do that thing or
take that action which increases the life of the place, in
the people, and in their environment.

— cite:alexander:2012battle p59.
#+end_quote
...
go.  It's too big, too dense -- too fucking much to fit in
your head in anything less than a couple of years.  So we
need to ease people into it, let them enter where they want
and when they want and however they approach it, the yellow
brick road will always arrive in Oz.

We could combine APL with the Whole Earth Catalog?
...
SEE: http://www.briarpress.org/39804
