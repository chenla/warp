...
[2018-05-19 Sat 20:37] I've been thinking about this the
wrong way -- we need scenarios that are structured around
two axis, succession stages and pace-layers.

The whole idea of scenarios should be to provide narratives
that pull all the of the ideas in w&w and show how they play
out in different situations.

My original idea was the idea of a fictional Plan of St Gall
that projects into the future -- but we should be thinking
about how to offer scenarios for how different societies at
different stages of economic development in different
climates and with different cultural ethos and mythos can
get from where they are, to where they want to go.

Then, we provide a couple of catastrophic scenarios to show
how we can leverage the w&w to weather the disaster and then
rebuild as quickly as possible.  A lot of succession stage
planning is, in effect, a way of preparing for disasters.
We could use to rebuild Puerto Rico so that they don't have
to go through the nightmare they are going through again,
with or without help from the mainland.
 
** TL;DR
My fear is that the scenarios are misunderstood in the way
that Soleri's fantastic 30 designs for arcologies were
...
engineers to build it. That isn't what Soleri intended at
all.
