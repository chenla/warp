...
Scale determines POV relative to the distance from a frame of
...
Human brains are designed to think this way -- we think in terms of a
present relative to a distinct past, an illusion created my memories
