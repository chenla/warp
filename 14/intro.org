...
at least threefold: to give a man a chance to utilise and
...
this view are endless. To organise work in such a manner
that it becomes meaningless, boring, stultifying, or
nerve-racking for the worker would be little short of
...
side of this worldly existence. EquaUy, to strive for
leisure as an altemative to work would be considered a
...
separated without destroying the joy of work and the bliss of
leisure.

From the Buddhist point of view, there are therefore two
types of mechanisation which must be clearly distinguished:
one that enhances a man's skill and power and one that turns
the work of man over to a mechanical slave ...

— cite:schumacher:1975small [[pdf:schumacher:1975small.pdf::55-56][p.55]]
#+end_quote
...
** References
  ...
  - Harford, T., The undercover economist: exposing why the
    rich are rich, the poor are poor and why you can never
    buy a decent used car! (fully revised&updated ed.)
    (2006), : Oxford University Press.
    cite:harford:2006undercover
  - Dixit, A., Microeconomics: a very short introduction
    (2014), : Oxford University Press.
    cite:dixit:2014microeconomics
  - Dasgupta, P., Economics: a very short introduction (very
    short introductions) (2007), : Oxford University Press,
    USA.
    cite:dasgupta:2007economics
