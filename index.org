...
mythos.  It can be used either as a primary evidence-based
narrative that is based on a pluralistic, secular humanistic
principles.

But it can also serve as an interoperability layer, an
eternal blue sky which everything is underneath.  In this
way, the Canon can map to local cultural mythos that
reflects their own context -- gods, geography, climate,
diet, traditions, history.
